...
function AuthPagesWrapper(props: React.PropsWithChildren<IAuthPagesWrapperProps>) {
  const { children, title = 'Sign in to Ezymote vehicle tracker', subTitle = 'Enter your details below' } = props;
